...
public class ServiceNowUpdateIncident extends ServiceNowProjectSpecificMethods{
	...
	@Test(priority = 2, dependsOnMethods = "assignment.week5day1.ServiceNowNewIncident.createNewIncident")
...
//		Step3: Enter password
		driver.findElement(By.id("user_password")).sendKeys("ONDBoct@2021");
//		Step4: Click Login
